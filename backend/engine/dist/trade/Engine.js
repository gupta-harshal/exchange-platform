...
import { CANCEL_ORDER, CREATE_ORDER, GET_BALANCE, GET_DEPTH, GET_OPEN_ORDERS, GET_TICKERS, GET_TRADES, ON_RAMP } from "../types/fromApi.js";
...
export class Engine {
    ...
    createDbTrades(fills, market, side) {
        fills.forEach(fill => {
    ...
    publishWsTrades(fills, side, market) {
        fills.forEach(fill => {
